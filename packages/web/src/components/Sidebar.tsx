...
const EXAMPLE_PROMPTS = [
  {
    title: "Zus Coffee Landing Page",
    description: "Build a landing page for a coffee shop with a modern design",
    prompt: "Create a simple landing page for Zus Coffee."
  }
];
      ...
      <div className="p-4 border-b border-gray-700">
        <div className="flex items-center gap-2 text-white">
          ...
          <div className="flex items-center gap-2">
            <h1 className="font-semibold">AI Web Gen POC</h1>
          </div>
        </div>
      </div>
